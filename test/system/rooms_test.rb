...
class RoomsTest < ApplicationSystemTestCase
  ...
  test "creating a Room" do
    ...
    fill_in "Czar", with: @room.czar
    check "Game started" if @room.game_started
    fill_in "Name", with: @room.name
    fill_in "Owner", with: @room.owner
    fill_in "Players", with: @room.players
    fill_in "Visibility", with: @room.visibility
